...
const MENU_ITEMS: MenuItem[] = [
  {
    ...
    directLink: {
      href: "products",
      category: "dattes-fraiches,dattes-transformees,dattes-farcies,paquetdattes-fraiches,coffretdattes-fraiches"
    },
    items: [
      { label: "Coffret de Dattes", href: "products", category: "coffretdattes-fraiches", subcategory: "coffret-cadeaux", translationKey: "navbar.gift_box" },
      { label: "Paquet de Dattes", href: "products", category: "paquetdattes-fraiches", subcategory: "paquet", translationKey: "navbar.packages" },
