...
const Home = ({ clientType }: HomeProps) => {
  ...
  return (
    <main className="flex-grow">
      <section className={`relative ${isMobile ? 'h-[50vh] mt-[3%]' : 'h-[calc(100vh-80px)]'}`}>
          ...
          {heroImages.map((item, index) => (
            ...
            >
             <img
                ...
                className={`w-full h-full ${isMobile ? 'object-contain object-center mt-[8.5%]' : 'object-contain mt-[5%]'}`}
        ...
        <div className={`absolute ${isMobile ? 'bottom-12' : 'bottom-8'}  left-0 right-0 flex items-center justify-center z-50`}>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="lg:w-[60%] space-y-8">
              ...
              <div
                ref={statsRef}
                className={`grid grid-cols-2 gap-4 pt-6 border-t border-gray-200 w-full ${isMobile ? 'gap-11' : ''}`}
              >
                {statistics
                  .filter(
                    (stat) =>
